...
Si la préemption est active lors de l'execution de l'ordonnanceur, ...
 ...
 La run-queue est verouillé au début de la fonction \textiŧ{schedule} (alors que le processus 'prev' vient de finir son créneau d'execution)
...
\section{Completely Fair Scheduling}
  ...
  \paragraph{Q.15} Cet algorithme se base sur les 'red-black tree' (arbre binaire bicolore \ref{rbtree})
	...
	\bibitem{rbtree}\label{rbtree}
        ...
        \href{https://fr.wikipedia.org/wiki/Arbre_bicolore}
        {\textit{https://fr.wikipedia.org/wiki/Arbre_bicolore}}\newline
