...
def solveAndPlot(theta, title):
	P = solve(theta)
	title = "Methode " + title + "(theta=" + str(theta) + ")"
...
E02 = 2 * np.linalg.norm(P0 - P2) / (N0 + N2)
E12 = 2 * np.linalg.norm(P1 - P2) / (N1 + N2)

print("Entre 0.0 et 0.5 (implicit et Crank Nicholson): " + str(E01))
print("Entre 0.0 et 1.0 (implicit et explicit)       : " + str(E02))
print("Entre 0.5 et 1.0 (explicit et Crank Nicholson): " + str(E12))
