...
public class EnsembleVector<E> extends EnsembleGenerique<E> {
	...
	/**
	 * Constructeur par défaut d'un ensemble à base de {@link Vectorx.Vector}
	 */
	 ...
	 * Vector si celui ci n'y est pas déjà présent
	 * 
	 * @param element
	...
	public Ensemble<E> union(Ensemble<E> ensemble) {
		EnsembleVector<E> res = new EnsembleVector<E>();
	 ...
	 * l'itérateur du Vector sous-jacent
	 * 
