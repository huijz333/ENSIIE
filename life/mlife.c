...
/* OPTIONS */
static int opt_rows = 25, opt_cols = 25, opt_iter = 10;
...
int main(int argc, char *argv[])
{
    ...
    // Evaluate and broadcast program options
    MLIFE_parse_args(argc, argv);
    // Duplicate the communicator (not mandatory but safer)
    ...
    // IO Communicateur must be freed
    MLIFEIO_Finalize();
...
       /* SLIDE: Life Point-to-Point Code Walkthrough */
    ...
    // If compiled with the mpi-io extension and restart option active
       /* SLIDE: Life Point-to-Point Code Walkthrough */
